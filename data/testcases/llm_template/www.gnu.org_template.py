...
print("STEP 9 - Check element title_9")
try:
...
print("STEP 13 - Check element style_13")
try:
...
print("STEP 34 - Check element body_34")
try:
...
print("STEP 35 - Check element div_35")
try:
...
print("STEP 37 - Check element p_37")
try:
...
print("STEP 39 - Check element b_39")
try:
...
print("STEP 42 - Check element p_42")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 42')
except Exception as e:
...
print("STEP 43 - Check element b_43")
try:
    element = driver.find_element(By.TAG_NAME, "b")
    print('PASS - step 43')
except Exception as e:
...
print("STEP 44 - Check element p_44")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 44')
except Exception as e:
...
print("STEP 46 - Check element span_46")
try:
...
print("STEP 47 - Check element p_47")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 47')
except Exception as e:
...
print("STEP 49 - Check element span_49")
try:
    element = driver.find_element(By.TAG_NAME, "span")
    print('PASS - step 49')
except Exception as e:
...
print("STEP 52 - Check element div_52")
try:
    element = driver.find_element(By.TAG_NAME, "div")
    print('PASS - step 52')
except Exception as e:
...
print("STEP 53 - Check element div_53")
try:
    element = driver.find_element(By.TAG_NAME, "div")
    print('PASS - step 53')
except Exception as e:
...
print("STEP 55 - Check element span_55")
try:
    element = driver.find_element(By.TAG_NAME, "span")
    print('PASS - step 55')
except Exception as e:
...
print("STEP 57 - Check element span_57")
try:
    element = driver.find_element(By.TAG_NAME, "span")
    print('PASS - step 57')
except Exception as e:
...
print("STEP 60 - Check element p_60")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 60')
except Exception as e:
...
print("STEP 62 - Check element img_62")
try:
...
print("STEP 63 - Check element strong_63")
try:
...
print("STEP 65 - Check element br_65")
try:
...
print("STEP 66 - Check element small_66")
try:
...
print("STEP 68 - Check element div_68")
try:
    element = driver.find_element(By.TAG_NAME, "div")
    print('PASS - step 68')
except Exception as e:
...
print("STEP 71 - Check element img_71")
try:
    element = driver.find_element(By.TAG_NAME, "img")
    print('PASS - step 71')
except Exception as e:
...
print("STEP 74 - Check element img_74")
try:
    element = driver.find_element(By.TAG_NAME, "img")
    print('PASS - step 74')
except Exception as e:
...
print("STEP 80 - Check element b_80")
try:
    element = driver.find_element(By.TAG_NAME, "b")
    print('PASS - step 80')
except Exception as e:
...
print("STEP 81 - Check element ul_81")
try:
...
print("STEP 116 - Check element p_116")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 116')
except Exception as e:
...
print("STEP 120 - Check element video_120")
try:
...
print("STEP 121 - Check element source_121")
try:
...
print("STEP 122 - Check element source_122")
try:
    element = driver.find_element(By.TAG_NAME, "source")
    print('PASS - step 122')
except Exception as e:
...
print("STEP 123 - Check element source_123")
try:
    element = driver.find_element(By.TAG_NAME, "source")
    print('PASS - step 123')
except Exception as e:
...
print("STEP 124 - Check element track_124")
try:
    element = driver.find_element(By.TAG_NAME, "track")
    print('PASS - step 124')
except Exception as e:
    print('FAIL - step 124' if isinstance(e, AssertionError) else f'ERROR - step 124: {e}')

print("STEP 125 - Check element track_125")
try:
    element = driver.find_element(By.TAG_NAME, "track")
    print('PASS - step 125')
except Exception as e:
...
print("STEP 126 - Check element track_126")
try:
    element = driver.find_element(By.TAG_NAME, "track")
    print('PASS - step 126')
except Exception as e:
...
print("STEP 127 - Check element track_127")
try:
    element = driver.find_element(By.TAG_NAME, "track")
    print('PASS - step 127')
except Exception as e:
...
print("STEP 128 - Check element track_128")
try:
    element = driver.find_element(By.TAG_NAME, "track")
    print('PASS - step 128')
except Exception as e:
...
print("STEP 129 - Check element p_129")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 129')
except Exception as e:
...
print("STEP 131 - Check element h2_131")
try:
...
print("STEP 132 - Check element p_132")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 132')
except Exception as e:
...
print("STEP 134 - Check element p_134")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 134')
except Exception as e:
...
print("STEP 137 - Check element p_137")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 137')
except Exception as e:
...
print("STEP 145 - Check element img_145")
try:
    element = driver.find_element(By.TAG_NAME, "img")
    print('PASS - step 145')
except Exception as e:
...
print("STEP 146 - Check element br_146")
try:
    element = driver.find_element(By.TAG_NAME, "br")
    print('PASS - step 146')
except Exception as e:
...
print("STEP 147 - Check element small_147")
try:
    element = driver.find_element(By.TAG_NAME, "small")
    print('PASS - step 147')
except Exception as e:
...
print("STEP 148 - Check element p_148")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 148')
except Exception as e:
...
print("STEP 150 - Check element img_150")
try:
    element = driver.find_element(By.TAG_NAME, "img")
    print('PASS - step 150')
except Exception as e:
...
print("STEP 151 - Check element br_151")
try:
    element = driver.find_element(By.TAG_NAME, "br")
    print('PASS - step 151')
except Exception as e:
...
print("STEP 152 - Check element small_152")
try:
    element = driver.find_element(By.TAG_NAME, "small")
    print('PASS - step 152')
except Exception as e:
...
print("STEP 153 - Check element p_153")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 153')
except Exception as e:
...
print("STEP 155 - Check element img_155")
try:
    element = driver.find_element(By.TAG_NAME, "img")
    print('PASS - step 155')
except Exception as e:
...
print("STEP 156 - Check element br_156")
try:
    element = driver.find_element(By.TAG_NAME, "br")
    print('PASS - step 156')
except Exception as e:
...
print("STEP 157 - Check element small_157")
try:
    element = driver.find_element(By.TAG_NAME, "small")
    print('PASS - step 157')
except Exception as e:
...
print("STEP 158 - Check element p_158")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 158')
except Exception as e:
...
print("STEP 160 - Check element img_160")
try:
    element = driver.find_element(By.TAG_NAME, "img")
    print('PASS - step 160')
except Exception as e:
...
print("STEP 161 - Check element br_161")
try:
    element = driver.find_element(By.TAG_NAME, "br")
    print('PASS - step 161')
except Exception as e:
...
print("STEP 162 - Check element small_162")
try:
    element = driver.find_element(By.TAG_NAME, "small")
    print('PASS - step 162')
except Exception as e:
...
print("STEP 166 - Check element br_166")
try:
    element = driver.find_element(By.TAG_NAME, "br")
    print('PASS - step 166')
except Exception as e:
...
print("STEP 167 - Check element small_167")
try:
    element = driver.find_element(By.TAG_NAME, "small")
    print('PASS - step 167')
except Exception as e:
...
print("STEP 168 - Check element p_168")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 168')
except Exception as e:
...
print("STEP 171 - Check element br_171")
try:
    element = driver.find_element(By.TAG_NAME, "br")
    print('PASS - step 171')
except Exception as e:
...
print("STEP 172 - Check element small_172")
try:
    element = driver.find_element(By.TAG_NAME, "small")
    print('PASS - step 172')
except Exception as e:
...
print("STEP 177 - Check element p_177")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 177')
except Exception as e:
...
print("STEP 179 - Check element h2_179")
try:
    element = driver.find_element(By.TAG_NAME, "h2")
    print('PASS - step 179')
except Exception as e:
...
print("STEP 180 - Check element p_180")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 180')
except Exception as e:
...
print("STEP 181 - Check element strong_181")
try:
    element = driver.find_element(By.TAG_NAME, "strong")
    print('PASS - step 181')
except Exception as e:
...
print("STEP 185 - Check element ul_185")
try:
    element = driver.find_element(By.TAG_NAME, "ul")
    print('PASS - step 185')
except Exception as e:
...
print("STEP 195 - Check element h2_195")
try:
    element = driver.find_element(By.TAG_NAME, "h2")
    print('PASS - step 195')
except Exception as e:
...
print("STEP 200 - Check element em_200")
try:
...
print("STEP 201 - Check element em_201")
try:
    element = driver.find_element(By.TAG_NAME, "em")
    print('PASS - step 201')
except Exception as e:
...
print("STEP 202 - Check element em_202")
try:
    element = driver.find_element(By.TAG_NAME, "em")
    print('PASS - step 202')
except Exception as e:
...
print("STEP 203 - Check element p_203")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 203')
except Exception as e:
...
print("STEP 205 - Check element strong_205")
try:
    element = driver.find_element(By.TAG_NAME, "strong")
    print('PASS - step 205')
except Exception as e:
...
print("STEP 207 - Check element p_207")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 207')
except Exception as e:
...
print("STEP 214 - Check element img_214")
try:
    element = driver.find_element(By.TAG_NAME, "img")
    print('PASS - step 214')
except Exception as e:
...
print("STEP 216 - Check element p_216")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 216')
except Exception as e:
...
print("STEP 219 - Check element blockquote_219")
try:
...
print("STEP 221 - Check element i_221")
try:
...
print("STEP 222 - Check element br_222")
try:
    element = driver.find_element(By.TAG_NAME, "br")
    print('PASS - step 222')
except Exception as e:
...
print("STEP 224 - Check element cite_224")
try:
...
print("STEP 226 - Check element h3_226")
try:
...
print("STEP 232 - Check element p_232")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 232')
except Exception as e:
...
print("STEP 235 - Check element span_235")
try:
    element = driver.find_element(By.TAG_NAME, "span")
    print('PASS - step 235')
except Exception as e:
...
print("STEP 237 - Check element p_237")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 237')
except Exception as e:
...
print("STEP 240 - Check element span_240")
try:
    element = driver.find_element(By.TAG_NAME, "span")
    print('PASS - step 240')
except Exception as e:
...
print("STEP 248 - Check element h3_248")
try:
    element = driver.find_element(By.TAG_NAME, "h3")
    print('PASS - step 248')
except Exception as e:
...
print("STEP 249 - Check element ul_249")
try:
    element = driver.find_element(By.TAG_NAME, "ul")
    print('PASS - step 249')
except Exception as e:
...
print("STEP 251 - Check element strong_251")
try:
    element = driver.find_element(By.TAG_NAME, "strong")
    print('PASS - step 251')
except Exception as e:
...
print("STEP 255 - Check element li_255")
try:
    element = driver.find_element(By.TAG_NAME, "li")
    print('PASS - step 255')
except Exception as e:
...
print("STEP 257 - Check element p_257")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 257')
except Exception as e:
...
print("STEP 258 - Check element a_258")
try:
    element = driver.find_element(By.TAG_NAME, "a")
    print('PASS - step 258')
except Exception as e:
...
print("STEP 261 - Check element strong_261")
try:
    element = driver.find_element(By.TAG_NAME, "strong")
    print('PASS - step 261')
except Exception as e:
...
print("STEP 262 - Check element ul_262")
try:
    element = driver.find_element(By.TAG_NAME, "ul")
    print('PASS - step 262')
except Exception as e:
...
print("STEP 269 - Check element strong_269")
try:
    element = driver.find_element(By.TAG_NAME, "strong")
    print('PASS - step 269')
except Exception as e:
...
print("STEP 273 - Check element strong_273")
try:
    element = driver.find_element(By.TAG_NAME, "strong")
    print('PASS - step 273')
except Exception as e:
...
print("STEP 275 - Check element ul_275")
try:
    element = driver.find_element(By.TAG_NAME, "ul")
    print('PASS - step 275')
except Exception as e:
...
print("STEP 277 - Check element span_277")
try:
    element = driver.find_element(By.TAG_NAME, "span")
    print('PASS - step 277')
except Exception as e:
...
print("STEP 284 - Check element p_284")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 284')
except Exception as e:
...
print("STEP 285 - Check element ul_285")
try:
    element = driver.find_element(By.TAG_NAME, "ul")
    print('PASS - step 285')
except Exception as e:
...
print("STEP 286 - Check element li_286")
try:
    element = driver.find_element(By.TAG_NAME, "li")
    print('PASS - step 286')
except Exception as e:
...
print("STEP 295 - Check element p_295")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 295')
except Exception as e:
...
print("STEP 298 - Check element strong_298")
try:
    element = driver.find_element(By.TAG_NAME, "strong")
    print('PASS - step 298')
except Exception as e:
...
print("STEP 300 - Check element p_300")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 300')
except Exception as e:
...
print("STEP 301 - Check element strong_301")
try:
    element = driver.find_element(By.TAG_NAME, "strong")
    print('PASS - step 301')
except Exception as e:
...
print("STEP 305 - Check element h4_305")
try:
...
print("STEP 307 - Check element p_307")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 307')
except Exception as e:
...
print("STEP 308 - Check element code_308")
try:
...
print("STEP 309 - Check element small_309")
try:
    element = driver.find_element(By.TAG_NAME, "small")
    print('PASS - step 309')
except Exception as e:
...
print("STEP 315 - Check element hr_315")
try:
...
print("STEP 317 - Check element b_317")
try:
    element = driver.find_element(By.TAG_NAME, "b")
    print('PASS - step 317')
except Exception as e:
...
print("STEP 326 - Check element p_326")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 326')
except Exception as e:
...
print("STEP 328 - Check element p_328")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 328')
except Exception as e:
...
print("STEP 365 - Check element blockquote_365")
try:
    element = driver.find_element(By.TAG_NAME, "blockquote")
    print('PASS - step 365')
except Exception as e:
...
print("STEP 368 - Check element img_368")
try:
    element = driver.find_element(By.TAG_NAME, "img")
    print('PASS - step 368')
except Exception as e:
...
print("STEP 369 - Check element strong_369")
try:
    element = driver.find_element(By.TAG_NAME, "strong")
    print('PASS - step 369')
except Exception as e:
...
print("STEP 371 - Check element a_371")
try:
    element = driver.find_element(By.TAG_NAME, "a")
    print('PASS - step 371')
except Exception as e:
...
print("STEP 374 - Check element p_374")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 374')
except Exception as e:
...
print("STEP 375 - Check element a_375")
try:
    element = driver.find_element(By.TAG_NAME, "a")
    print('PASS - step 375')
except Exception as e:
...
print("STEP 379 - Check element br_379")
try:
    element = driver.find_element(By.TAG_NAME, "br")
    print('PASS - step 379')
except Exception as e:
...
print("STEP 388 - Check element p_388")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 388')
except Exception as e:
...
print("STEP 390 - Check element p_390")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 390')
except Exception as e:
...
print("STEP 393 - Check element p_393")
try:
    element = driver.find_element(By.TAG_NAME, "p")
    print('PASS - step 393')
except Exception as e:
